-- ============================================================
-- Migration 044: Harden game score RPC validation
-- Keeps score math aligned while rejecting malformed payloads.
-- ============================================================
...
BEGIN
  ...
  IF p_filter_used NOT IN ('global', 'user_learning', 'user_learned', 'mixed') THEN
